...
class QRGenerator:
    ...
    #     del dir_
    #     return res
    def __call__(self, url, logo, version=None, qr="mono dark", encoding="utf8"):
        if qr == "colored light":
            color1 = "#517BD6"
            color2 = "#51A8D6"
            color3 = "#5192D6"
        ...
        if count[-1] < _length:
            raise ValueError(
                'Text length must be lower by "{count}"'.format(count=count[-1] - 1)
            )
        _version = 0
        ...
        if _version > version:
            raise ValueError(
                "Not encode QR-code with version={version}".format(version=version)
            )
            ...
            for x in range(count):
                if self.code[y][x]:
                    ...
                    if worked:
                        if end:
                            idraw.ellipse(
                                (10 + 10 * x, 10 + 10 * y, 20 + 10 * x, 20 + 10 * y),
                                fill=color3,
                            )
                            if not start:
                                idraw.rectangle(
        ...
        idraw.rectangle(
            ((count - 7) * 10 + 10, 10, count * 10 + 10, 80), fill=wallpaper
        )
        idraw.rectangle(
            (10, (count - 7) * 10 + 10, 80, count * 10 + 10), fill=wallpaper
        )
        for start in [(0, 0), ((count - 7) * 10, 0), (0, (count - 7) * 10)]:
            idraw.ellipse(
                (start[0] + 10, start[1] + 10, start[0] + 50, start[1] + 50),
                fill=color1,
            )
            idraw.ellipse(
                (start[0] + 20, start[1] + 20, start[0] + 40, start[1] + 40),
                fill=wallpaper,
            )
            idraw.ellipse(
                (start[0] + 40, start[1] + 40, start[0] + 80, start[1] + 80),
                fill=color1,
            )
            idraw.ellipse(
                (start[0] + 50, start[1] + 50, start[0] + 70, start[1] + 70),
                fill=wallpaper,
            )
            idraw.ellipse(
                (start[0] + 10, start[1] + 40, start[0] + 50, start[1] + 80),
                fill=color1,
            )
            idraw.ellipse(
                (start[0] + 20, start[1] + 50, start[0] + 40, start[1] + 70),
                fill=wallpaper,
            )
            idraw.ellipse(
                (start[0] + 40, start[1] + 10, start[0] + 80, start[1] + 50),
                fill=color1,
            )
            idraw.ellipse(
                (start[0] + 50, start[1] + 20, start[0] + 70, start[1] + 40),
                fill=wallpaper,
            )

            idraw.rectangle(
                (start[0] + 30, start[1] + 10, start[0] + 60, start[1] + 80),
                fill=wallpaper,
            )
            idraw.rectangle(
                (
            ...
            idraw.rectangle(
                (start[0] + 30, start[1] + 10, start[0] + 60, start[1] + 19),
                fill=color1,
            )
            idraw.rectangle(
                (start[0] + 10, start[1] + 30, start[0] + 19, start[1] + 60),
                fill=color1,
            )
            idraw.rectangle(
                (start[0] + 71, start[1] + 30, start[0] + 80, start[1] + 61),
                fill=color1,
            )
            idraw.rectangle(
                (start[0] + 30, start[1] + 71, start[0] + 61, start[1] + 80),
                fill=color1,
            )

            idraw.ellipse(
                (start[0] + 30, start[1] + 30, start[0] + 45, start[1] + 45),
                fill=color2,
            )
            idraw.ellipse(
                (start[0] + 30, start[1] + 45, start[0] + 45, start[1] + 60),
                fill=color2,
            )
            idraw.ellipse(
                (start[0] + 45, start[1] + 30, start[0] + 60, start[1] + 45),
                fill=color2,
            )
            idraw.ellipse(
                (start[0] + 45, start[1] + 45, start[0] + 60, start[1] + 60),
                fill=color2,
            )

            idraw.rectangle(
                (start[0] + 35, start[1] + 30, start[0] + 55, start[1] + 59),
                fill=color2,
            )
            idraw.rectangle(
                (start[0] + 30, start[1] + 35, start[0] + 59, start[1] + 55),
                fill=color2,
            )
