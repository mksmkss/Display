...
def generate_sample_pdf(excel_path,output_path):
    ...
    for i in range(page_len):
        ...
        while  (j < cards_num[0] * cards_num[1]):
            ...
            #A4のpdfを作成する
            if system == 'Darwin':
                file_name = '{}/Sample PDF/qr_{}.pdf'.format(output_path,i)
            else:
                file_name = '{}\\Sample PDF\\qr_{}.pdf'.format(output_path,i)
            ...
            for y in range(cards_num[1]):
                for x in range(cards_num[0]):
                    ...
                    page.drawString(pos[0] + card[0]/2 - id_width/2,pos[1] + 10,id)
...
if __name__ == "__main__":
    generate_sample_pdf("/Users/masataka/Desktop/写真展フォーム　テンプレート.xlsx","/Users/masataka/Desktop/Data")
