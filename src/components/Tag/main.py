...
def generate_tag_pdf(excel_path,output_path):
    ...
    for i in range(page_len):
        ...
        while  (j < cards_num[0] * cards_num[1]):
            ...
            if system == 'Darwin':
                file_name = '{}/Tag PDF/tag_{}.pdf'.format(output_path,i)
            else:
                file_name = '{}\\Tag PDF\\tag_{}.pdf'.format(output_path,i)
            ...
            for y in range(cards_num[1]):
                for x in range(cards_num[0]):
                    ...
                    for k in range(len(title_list)):
                        ...
                        title_width_list.append(round(page.stringWidth(title_list[k],'Meiryo UI',25)))
...
if __name__ == "__main__":
    generate_tag_pdf("/Users/masataka/Desktop/写真展フォーム　テンプレート.xlsx","/Users/masataka/Desktop/Data")
